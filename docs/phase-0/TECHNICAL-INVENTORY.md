...
| systemd | `tehus-backup.{service,timer}`, `tehus-backup-drill.{service,timer}`, `tehus-backup-init.service` | Instalados; timers `enabled`/`active (waiting)` desde 2026-09-02: backup diario 03:00 Colombia (08:00 UTC), drill día 1 de cada mes 04:30–04:45 Colombia (09:30–09:45 UTC). Primer disparo automático del backup: 2026-09-03 03:00:18 Colombia, `Result=success` |
