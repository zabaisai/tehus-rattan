  ...
  return (
    <div>
      ...
      <div className="mt-4 flex flex-wrap items-center gap-2">
        <div className="inline-flex rounded-md border border-stone-200 p-0.5" role="tablist">
        ...
        <select
          ...
          className="rounded-md border border-stone-300 px-2 py-1.5 text-sm outline-none focus:border-stone-500 focus:ring-1 focus:ring-stone-500"
        >
        ...
        {query.isLoading ? (
          ...
          <div className="px-4 py-10 text-center">
            ...
            <button
              ...
              className="mt-2 rounded-md border border-stone-300 px-3 py-1.5 text-sm text-stone-700 hover:bg-stone-50"
            >
              Reintentar
            </button>
          </div>
            ...
            {items.map((n) => (
              <li key={n.id}>
                <button
                  type="button"
                  onClick={() => open(n)}
                  className={`flex w-full items-start gap-3 px-4 py-3 text-left hover:bg-stone-50 ${n.readAt ? '' : 'bg-emerald-50/40'}`}
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    {n.bodyPreview && (
                      <span className="mt-0.5 block text-sm text-stone-500">{n.bodyPreview}</span>
                    )}
