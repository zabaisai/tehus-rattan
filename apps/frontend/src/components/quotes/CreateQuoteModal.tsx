...
export function CreateQuoteModal({ leadId, onClose, onCreated }: CreateQuoteModalProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const quote = await createQuoteFromLead(leadId, {
      ...
      setError(errorMessage || 'No se pudo crear la cotización');
    } finally {
      setSaving(false);
    }
  }
